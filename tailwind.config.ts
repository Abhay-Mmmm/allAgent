...
export default {
  ...
  theme: {
    container: {
      ...
      padding: "1rem",
      screens: {
        "2xl": "480px", // Mobile-first, max width for rural devices
      },
    },
    extend: {
      colors: {
      ...
      fontSize: {
        ...
        "accessible-lg": ["1.25rem", { lineHeight: "1.5" }],
        "accessible-xl": ["1.5rem", { lineHeight: "1.4" }],
        "accessible-2xl": ["1.875rem", { lineHeight: "1.3" }],
      },
      spacing: {
