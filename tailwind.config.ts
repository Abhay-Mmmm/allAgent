  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        "accessible-lg": ["1.1875rem", { lineHeight: "1.5" }],
        "accessible-xl": ["1.375rem", { lineHeight: "1.4" }],
        "accessible-2xl": ["1.75rem", { lineHeight: "1.3" }],
      },
      spacing: {
        "touch": "44px",
        "touch-lg": "52px",
      ...
      boxShadow: {
        ...
        "soft-lg": "0 8px 30px -6px rgba(0, 0, 0, 0.12), 0 4px 12px -4px rgba(0, 0, 0, 0.06)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
